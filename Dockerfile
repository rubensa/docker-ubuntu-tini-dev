...
ARG DOCKERCOMPOSE_VERSION=2.35.1
...
ARG DOCKERBUILDX_VERSION=0.23.0
...
# Python 3.12.9 conda 25.3.1 release 1 (https://www.anaconda.com/docs/getting-started/miniconda/release-notes#miniconda-25-3-1-1)
ARG MINICONDA_VERSION=py312_25.3.1-1
...
ARG RUBY_BUILD_VERSION=20250430
